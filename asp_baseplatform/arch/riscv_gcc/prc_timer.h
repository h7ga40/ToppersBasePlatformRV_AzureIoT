 ...
 */
extern void	prc_timer_initialize(intptr_t exinf);
 ...
 *  タイマの動作を停止させる．
 */
extern void	prc_timer_terminate(intptr_t exinf);

/*
 *  タイマ割込み要求のチェック
 */
Inline bool_t
prc_timer_probe_int(void)
{
	return (read_csr(mip) & MIP_MTIP) != 0;
}

/*
 *  タイマ割込みハンドラ
 */
extern void	prc_timer_handler(void);

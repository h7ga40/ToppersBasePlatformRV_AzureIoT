...
typedef __int64_t	int64_t;			/* 符号付き64ビット整数 */
typedef __uint64_t	uint64_t;			/* 符号無し64ビット整数 */
#else
...
typedef __intptr_t			intptr_t;	/* ポインタを格納できる符号付き整数 */
typedef __uintptr_t			uintptr_t;	/* ポインタを格納できる符号無し整数 */

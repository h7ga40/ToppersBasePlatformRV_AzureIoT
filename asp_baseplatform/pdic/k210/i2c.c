...
static I2C_Handle_t i2cHandle[3];
 ...
 */
static void
i2c_send_data(I2C_Handle_t *hi2c)
{
 ...
 */
static void
i2c_recv_data(I2C_Handle_t *hi2c)
{
	uint32_t fifo_len, i, tmp;
 ...
 */
I2C_Handle_t *
i2c_init(ID portid, I2C_Init_t *ii2c)
{
	I2C_Handle_t *hi2c;
...
i2c_slaveread(I2C_Handle_t *hi2c, uint8_t *pData, uint16_t Size)
{
	...
	i2c_recv_data(hi2c);
	ercd = i2c_transwait(hi2c, I2C_TIMEOUT);
...
{
	ER ercd = E_OK;
	int32_t  send_buf_len, timeout = I2C_TIMEOUT;
 ...
 */
void
i2c_isr(intptr_t exinf)
{
	I2C_Handle_t *hi2c = &i2cHandle[INDEX_I2C(exinf)];
